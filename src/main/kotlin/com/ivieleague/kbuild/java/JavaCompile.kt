 ...
 * compiles once. [classpathJars] is a resolved, static input used directly.
 *
...
suspend fun javaCompile(
    ...
    return withContext(Dispatchers.IO) {
        val inputFiles = sources.asSequence().flatMap { it.walkTopDown() }.filter { it.extension == "java" }.toList()
